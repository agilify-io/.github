...
the Monetu / InvestDesk / Apura product grid (badges + descriptions), and the contact block.
...
- Brand colors via shields.io badges (Monetu gold `d97706`, InvestDesk green `059669`, Apura purple `7c3aed`).
