...
the Monetu / InvestDesk / EuPJ / Clioteca product grid (badges + descriptions), and the contact block.
...
- Brand colors via shields.io badges (Monetu gold `d97706`, InvestDesk green `059669`, EuPJ purple `7c3aed`, Clioteca azure `2563eb`).
